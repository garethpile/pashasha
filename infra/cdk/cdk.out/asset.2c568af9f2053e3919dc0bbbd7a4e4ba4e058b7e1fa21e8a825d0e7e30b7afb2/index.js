  ...
  '../../node_modules/qrcode/lib/core/mask-pattern.js'(exports2) {
    ...
    exports2.getBestMask = function getBestMask(data, setupFormatFunc) {
      ...
      for (let p = 0; p < numPatterns; p++) {
        ...
        const penalty =
          exports2.getPenaltyN1(data) +
          exports2.getPenaltyN2(data) +
          exports2.getPenaltyN3(data) +
          exports2.getPenaltyN4(data);
        exports2.applyMask(p, data);
...
var require_error_correction_code = __commonJS({
  '../../node_modules/qrcode/lib/core/error-correction-code.js'(exports2) {
    ...
    exports2.getTotalCodewordsCount = function getTotalCodewordsCount(
      version,
...
var require_bitpacker = __commonJS({
  '../../node_modules/pngjs/lib/bitpacker.js'(exports2, module2) {
    ...
    module2.exports = function (dataIn, width, height, options) {
      let outHasAlpha =
        [constants.COLORTYPE_COLOR_ALPHA, constants.COLORTYPE_ALPHA].indexOf(options.colorType) !==
        -1;
...
var require_server = __commonJS({
  '../../node_modules/qrcode/lib/server.js'(exports2) {
    ...
    exports2.toBuffer = function toBuffer2(text, opts, cb) {
      const params = checkParams(text, opts, cb);
      const renderer = getRendererFromType(params.opts.type);
...
var QRCode = __toESM(require_lib());
...
var USER_ASSETS_BUCKET = process.env.USER_ASSETS_BUCKET;
var GUARD_PORTAL_BASE =
...
async function ensureGuardAssets(input) {
  ...
  const token = (0, import_crypto.randomUUID)().replace(/-/g, '').slice(0, 16);

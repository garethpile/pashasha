  ...
  p = (e, o, n, t) => {
    if ((o && typeof o == 'object') || typeof o == 'function')
      for (let r of f(o))
        !P.call(e, r) &&
          r !== n &&
          d(e, r, { get: () => o[r], enumerable: !(t = w(o, r)) || t.enumerable });
    return e;
  },
  S = (e, o, n) => (
    (n = e != null ? h(C(e)) : {}),
    p(o || !e || !e.__esModule ? d(n, 'default', { value: e, enumerable: !0 }) : n, e)
  ),
...
async function E(e, o) {
  try {
    ...
    if (
      ...
      let g = new i.CloudWatchLogsClient({ logger: console, region: process.env.AWS_REGION });
    ...
    (console.log(t), await n('FAILED', t.message, e.ResourceProperties.LogGroupName));
  }
  function n(t, r, s) {
    ...
    let m = require('url').parse(e.ResponseURL),
      c = {
        ...
        path: m.path,
        method: 'PUT',
        headers: { 'content-type': '', 'content-length': Buffer.byteLength(a, 'utf8') },
      };
  ...
  return async (t) => {
    ...
    do
      try {
        ...
        if (s.name === 'OperationAbortedException' || s.name === 'ThrottlingException')
          if (r < e) {
